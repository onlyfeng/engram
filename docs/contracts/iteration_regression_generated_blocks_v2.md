# Iteration Regression Generated Blocks v2
> 版本: v2.0  
> 生效日期: 2026-02-03  
...
> **版本化原则**：如需变更受控块契约（breaking），必须新增 `iteration_regression_generated_blocks_v3.md`；本文档仅允许非破坏性勘误，保持当前版本稳定。
...
5. 版本升级：breaking 变更必须新建 `iteration_regression_generated_blocks_v3.md`。
