...
class TestRateLimited429:
    ...
    def test_429_without_retry_after_uses_exponential_backoff(
        self, client_factory, mock_token_provider, requests_mock
    ):
...
class TestAuthErrors401403:
    ...
    def test_401_triggers_invalidate_and_retry_once(
        self, client_factory, mock_token_provider, requests_mock
    ):
    ...
    def test_403_triggers_invalidate_and_retry_once(
        self, client_factory, mock_token_provider, requests_mock
    ):
    ...
    def test_401_only_retries_once_after_invalidate(
        self, client_factory, mock_token_provider, requests_mock
    ):
    ...
    def test_403_only_retries_once_after_invalidate(
        self, client_factory, mock_token_provider, requests_mock
    ):
...
class TestRequestSafeMode:
    ...
    def test_429_returns_result_without_exception(
        self, client_factory, mock_token_provider, requests_mock
    ):
    ...
    def test_500_returns_result_without_exception(
        self, client_factory, mock_token_provider, requests_mock
    ):
...
class TestTimeoutHandling:
    ...
    def test_timeout_max_attempts_exceeded(
        self, client_factory, mock_token_provider, requests_mock
    ):
...
class TestRateLimitHeaders:
    ...
    def test_429_headers_recorded_in_stats(
        self, client_factory, mock_token_provider, requests_mock
    ):
    ...
    def test_429_signal_readable_by_caller(
        self, client_factory, mock_token_provider, requests_mock
    ):
        """验证上层调用者可以读取 429 信号"""
        client = client_factory(max_attempts=1)
    ...
    def test_429_exception_contains_retry_after(
        self, client_factory, mock_token_provider, requests_mock
    ):
...
class TestRateLimiterPauseOn429:
    ...
    def test_429_with_retry_after_pauses_limiter(self, mock_token_provider, requests_mock):
        ...
        with patch.object(client.rate_limiter, "pause_until", side_effect=mock_pause):
            with patch.object(
                client.rate_limiter,
                "notify_rate_limit",
                wraps=client.rate_limiter.notify_rate_limit,
            ) as mock_notify:
                client.request_safe("GET", "/projects/123/repository/commits")
    ...
    def test_429_with_rate_limit_reset_pauses_limiter(self, mock_token_provider, requests_mock):
        ...
        with patch.object(
            client.rate_limiter, "notify_rate_limit", wraps=client.rate_limiter.notify_rate_limit
        ) as mock_notify:
            client.request_safe("GET", "/projects/123/repository/commits")
...
class TestStatsIncludeRateLimitFields:
    ...
    def test_client_stats_includes_rate_limit_fields_on_429(
        self, mock_token_provider, requests_mock
    ):
    ...
    def test_client_stats_rate_limit_fields_not_present_without_429(
        self, mock_token_provider, requests_mock
    ):
...
class Test429HeaderPriorityAndClamp:
    ...
    def test_retry_after_takes_priority_over_reset(
        self, client_factory, mock_token_provider, requests_mock
    ):
    ...
    def test_reset_time_used_when_no_retry_after(
        self, client_factory, mock_token_provider, requests_mock
    ):
...
class Test429HeaderCombinations:
    ...
    def test_invalid_rate_limit_reset_header(
        self, client_factory, mock_token_provider, requests_mock
    ):
...
class TestTokenProviderFactory:
    ...
    def test_fallback_to_env_default(self):
        ...
        from engram.logbook.scm_auth import EnvTokenProvider, create_token_provider_for_instance
    ...
    def test_normalize_instance_key(self):
        ...
        # 连字符替换为下划线
        assert (
            normalize_instance_key("gitlab-internal.example.com") == "gitlab_internal_example_com"
        )
