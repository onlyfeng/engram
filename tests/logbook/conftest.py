...
from engram.logbook.schema_context import SchemaContext, set_schema_context, reset_schema_context
...
def roles_applied_db(test_db_info: dict) -> Generator[dict, None, None]:
    ...
    try:
        ...
        with conn.cursor() as cur:
            ...
            if cur.fetchone():
                cur.execute("ALTER ROLE logbook_migrator WITH LOGIN PASSWORD %s", (migrator_password,))
            else:
