...
class TestPolicyEquivalence:
    ...
    @pytest.mark.parametrize("bucket,prefixes_csv", [
    ...
    def test_app_policy_equivalence(self, bucket: str, prefixes_csv: str):
        ...
        assert extract_condition_prefixes(shell_list_bucket) == extract_condition_prefixes(python_list_bucket)
