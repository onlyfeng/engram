...
class TestKeyIsolationEnhanced:
    ...
    def test_normalize_instance_key_extracts_hostname_from_url(self):
        ...
        assert normalize_instance_key_for_cb("https://gitlab.example.com/path") == "gitlab.example.com"
        assert normalize_instance_key_for_cb("http://GITLAB.EXAMPLE.COM:8080/api") == "gitlab.example.com:8080"
...
class TestStatePersistenceConsistency:
    ...
    def test_state_dict_contains_all_required_fields(self):
        ...
        # 建立一些状态
        stats = {"total_runs": 10, "failed_rate": 0.2, "rate_limit_rate": 0.1, "total_requests": 50, "total_timeout_count": 3}
        controller.check(stats)
