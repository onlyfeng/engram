...
class TestCheckDedup:
    ...
    def test_check_dedup_no_match(self, migrated_db):
        ...
        try:
            with patch('engram_step1.outbox.get_connection') as mock_get_conn:
                ...
                from engram_step1.outbox import check_dedup
    ...
    def test_claim_outbox_basic(self, migrated_db):
        ...
        try:
            ...
            with patch('engram_step1.outbox.get_connection') as mock_get_conn:
                ...
                from engram_step1.outbox import claim_outbox
    ...
    def test_ack_sent_success(self, migrated_db):
        ...
        try:
            ...
            with patch('engram_step1.outbox.get_connection') as mock_get_conn:
                ...
                from engram_step1.outbox import ack_sent
    ...
    def test_fail_retry_with_specified_time(self, migrated_db):
        ...
        try:
            ...
            with patch('engram_step1.outbox.get_connection') as mock_get_conn:
                ...
                from engram_step1.outbox import fail_retry
    ...
    def test_mark_dead_success(self, migrated_db):
        ...
        try:
            ...
            with patch('engram_step1.outbox.get_connection') as mock_get_conn:
                ...
                from engram_step1.outbox import mark_dead_by_worker
    ...
    def test_renew_lease_success(self, migrated_db):
        ...
        try:
            ...
            with patch('engram_step1.outbox.get_connection') as mock_get_conn:
                ...
                from engram_step1.outbox import renew_lease
    ...
    def test_renew_lease_batch_success(self, migrated_db):
        ...
        try:
            ...
            with patch('engram_step1.outbox.get_connection') as mock_get_conn:
                ...
                from engram_step1.outbox import renew_lease_batch
