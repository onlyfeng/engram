...
class TestErrorRedaction:
    ...
    def test_redact_bearer_token_in_error(self):
        ...
        error_with_bearer = "Request failed: Authorization: Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.xxx"
    ...
    def test_redact_authorization_header_in_error(self):
        ...
        error_with_auth = "HTTP 401: Authorization header invalid: Authorization: Basic dXNlcjpwYXNzd29yZA=="
    ...
    def test_fail_retry_redacts_error_with_token(self, migrated_db):
        ...
        try:
            ...
            from engram_step1.scm_sync_queue import fail_retry
            ...
            assert "[REDACTED]" in stored_error or "[GITLAB_TOKEN]" in stored_error or "[TOKEN]" in stored_error
...
class TestGitLabAuthFallback:
    ...
    def test_gitlab_private_token_env_fallback_in_config(self):
        ...
        env_backup = {
            ...
            for k in ["GITLAB_TOKEN", "GITLAB_PRIVATE_TOKEN"]
        }
        ...
        try:
            ...
            from engram_step1.config import get_gitlab_auth, Config
    ...
    def test_gitlab_private_token_env_fallback_in_scm_auth(self):
        ...
        try:
            ...
            from engram_step1.scm_auth import create_gitlab_token_provider
    ...
    def test_create_token_provider_fallback(self):
        ...
        try:
            ...
            from engram_step1.scm_auth import create_token_provider
    ...
    def test_no_token_env_raises_validation_error(self):
        ...
        try:
            from engram_step1.scm_auth import create_token_provider, TokenValidationError
...
class TestSVNAuthFallback:
    ...
    def test_svn_password_env_fallback(self):
        ...
        env_backup = {
            k: os.environ.pop(k, None)
            for k in ["SVN_USERNAME", "SVN_PASSWORD"]
        }
        ...
        try:
            ...
            from engram_step1.config import get_svn_auth, Config
...
class TestSVNEnvInjection:
    ...
    def test_svn_password_env_config_injection(self):
        ...
        env_backup = {
            k: os.environ.pop(k, None)
            for k in ["SVN_USERNAME", "SVN_PASSWORD", "MY_SVN_SECRET"]
        }
    ...
    def test_svn_multiple_env_fallback_chain(self):
        ...
        try:
            ...
            from engram_step1.config import get_svn_auth
            from unittest.mock import MagicMock
...
class TestErrorRedactionBeforeDBStorage:
    ...
    def test_error_summary_redacted_before_db_write(self):
        ...
        from engram_step1.scm_auth import redact_dict, redact
