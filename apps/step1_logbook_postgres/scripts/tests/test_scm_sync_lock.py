...
class TestClaim:
    ...
    def test_claim_new_lock(self, migrated_db):
        ...
        try:
            ...
            with patch('engram_step1.scm_sync_lock.get_connection') as mock_get_conn:
                ...
                from engram_step1.scm_sync_lock import claim, get
    ...
    def test_claim_existing_unlocked(self, migrated_db):
        ...
        try:
            ...
            with patch('engram_step1.scm_sync_lock.get_connection') as mock_get_conn:
                ...
                from engram_step1.scm_sync_lock import claim
        ...
        try:
            ...
            def try_claim(worker_id):
                try:
                    ...
                    with patch('engram_step1.scm_sync_lock.get_connection', return_value=test_conn):
                        from engram_step1.scm_sync_lock import claim
    ...
    def test_renew_success(self, migrated_db):
        ...
        try:
            ...
            with patch('engram_step1.scm_sync_lock.get_connection') as mock_get_conn:
                ...
                from engram_step1.scm_sync_lock import renew, get
    ...
    def test_renew_wrong_worker(self, migrated_db):
        ...
        try:
            ...
            with patch('engram_step1.scm_sync_lock.get_connection') as mock_get_conn:
                ...
                from engram_step1.scm_sync_lock import renew
    ...
    def test_release_success(self, migrated_db):
        ...
        try:
            ...
            with patch('engram_step1.scm_sync_lock.get_connection') as mock_get_conn:
                ...
                from engram_step1.scm_sync_lock import release, get
    ...
    def test_release_nonexistent_lock(self, migrated_db):
        ...
        try:
            ...
            with patch('engram_step1.scm_sync_lock.get_connection') as mock_get_conn:
                ...
                from engram_step1.scm_sync_lock import release
    ...
    def test_get_existing_lock(self, migrated_db):
        ...
        try:
            ...
            with patch('engram_step1.scm_sync_lock.get_connection') as mock_get_conn:
                ...
                from engram_step1.scm_sync_lock import get
    ...
    def test_force_release_success(self, migrated_db):
        ...
        try:
            ...
            with patch('engram_step1.scm_sync_lock.get_connection') as mock_get_conn:
                ...
                from engram_step1.scm_sync_lock import force_release, get
        ...
        try:
            ...
            def simulate_sync_with_lock(worker_id: str, job_type: str, hold_seconds: float = 1.0):
                ...
                try:
                    ...
                    with patch('engram_step1.scm_sync_lock.get_connection', return_value=test_conn):
                        from engram_step1.scm_sync_lock import claim, release
    ...
    def test_list_locks_by_worker(self, migrated_db):
        ...
        try:
            ...
            with patch('engram_step1.scm_sync_lock.get_connection') as mock_get_conn:
                ...
                from engram_step1.scm_sync_lock import list_locks_by_worker
    ...
    def test_list_expired_locks(self, migrated_db):
        ...
        try:
            ...
            with patch('engram_step1.scm_sync_lock.get_connection') as mock_get_conn:
                ...
                from engram_step1.scm_sync_lock import list_expired_locks
