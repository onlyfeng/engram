...
class TestGitLabClientMock:
    ...
    def test_api_error_handling(self, client, requests_mock):
        """Mock API 错误处理"""
        from engram_step1.gitlab_client import GitLabAuthError
    ...
    def test_api_timeout_handling(self, client, requests_mock):
        """Mock API 超时处理"""
        from engram_step1.gitlab_client import GitLabTimeoutError
...
class TestHttpErrorHandling:
    ...
    def test_429_with_retry_after(self, client, requests_mock):
        ...
        from engram_step1.gitlab_client import GitLabRateLimitError
    ...
    def test_401_triggers_token_invalidate(self, requests_mock):
        ...
        from engram_step1.gitlab_client import GitLabClient, HttpConfig, GitLabAuthError
