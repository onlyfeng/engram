...
from step1_cli import app, artifacts_app
...
def mock_store(temp_artifacts_dir):
    ...
    # 重置全局 store 缓存
    from engram_step1.artifact_store import reset_default_store
    reset_default_store()
...
class TestStepOneCLIArtifactsIntegration:
    """step1_cli.py artifacts 子命令集成测试"""

    def test_step1_cli_has_artifacts_subcommand(self, runner):
        """测试 step1_cli 包含 artifacts 子命令"""
