"""
engram_step1.governance - 治理设置与审计模块
...
def insert_write_audit(
    ...
    使用示例:
        from engram_step1.uri import build_evidence_ref_for_patch_blob, build_evidence_refs_json
...
def write_audit(
    ...
    使用示例:
        from engram_step1.uri import build_evidence_ref_for_patch_blob
