"""
engram_step1.artifact_store - 制品存储抽象层
...
def get_artifact_store_from_config(config: Any) -> ArtifactStore:
    ...
    示例:
        from engram_step1.config import get_app_config
        from engram_step1.artifact_store import get_artifact_store_from_config
