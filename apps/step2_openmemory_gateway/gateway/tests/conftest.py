...
提供:
- PostgreSQL 临时数据库 + 自动建表（复用 Step1 的 test DB fixture 思路）
...
def ensure_step1_path():
    """确保可以导入 engram_step1 包"""
...
# ---------- step1_adapter 配置 Fixture ----------

@pytest.fixture(scope="function")
def step1_adapter_config(migrated_db: dict):
    """
    配置 step1_adapter 使用测试数据库
