...
try:
    ...
    class ErrorCode:  # type: ignore[no-redef]
        ...
        OPENMEMORY_CONSISTENCY_FAILED_INVALID_PAYLOAD = (
            "openmemory_consistency_failed:invalid_payload"
        )
        OPENMEMORY_CONSISTENCY_FAILED_MEMORY_ID_MISMATCH = (
            "openmemory_consistency_failed:memory_id_mismatch"
        )
        OPENMEMORY_CONSISTENCY_FAILED_SPACE_MISMATCH = (
        ...
        # 入参校验相关错误码
        # -------------------------------------------------------------------------
        INVALID_SPACE_FORMAT = "invalid_space_format"
